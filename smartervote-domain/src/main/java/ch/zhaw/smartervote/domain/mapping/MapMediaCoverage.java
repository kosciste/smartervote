...
public class MapMediaCoverage {
     ...
     */
    public static MediaEntryTO toTransferObject(MediaCoverage entity) {
        return new MediaEntryTO(entity.getHeadline(),entity.getDescription(),entity.getLink(),entity.getEventDate());
    }
